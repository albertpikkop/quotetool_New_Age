...
import { Package, LogIn, UserPlus, HelpCircle, BookOpen } from 'lucide-react';
      ...
      <div className="container mx-auto">
        ...
        <div className="h-12 px-2 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            {/* Additional Links (visible on larger screens) */}
            <div className="hidden min-[1056px]:flex items-center gap-2">
              <Link
                to="/faq"
