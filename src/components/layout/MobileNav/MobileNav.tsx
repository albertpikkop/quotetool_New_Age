...
export function MobileNav() {
  ...
  const isLargeScreen = useMediaQuery('(min-width: 1056px)');
  ...
  return (
    <>
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-md border-t safe-area-bottom z-40">
